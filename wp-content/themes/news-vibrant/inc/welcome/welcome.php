...
<?php
	...
	public function news_vibrant_theme_review_notice() {
		 ...
		 */
		if ( ( get_option( 'news_vibrant_theme_installed_time' ) > strtotime( '-15 day' ) ) || ( $ignored_notice_partially > strtotime( '-15 day' ) ) || ( $ignored_notice ) ) {
			return;
		}
?>
...
<?php
	...
	public function news_vibrant_ignore_theme_review_notice_partially() {
		...
		if ( isset( $_GET['nag_news_vibrant_ignore_theme_review_notice_partially'] ) && '0' == $_GET['nag_news_vibrant_ignore_theme_review_notice_partially'] ) {
			update_user_meta( $user_id, 'nag_news_vibrant_ignore_theme_review_notice_partially', time() );
		}
    ...
    public function news_vibrant_admin_footer_text( $text ) {
        ...
        if ( 'appearance_page_news-vibrant-welcome' == $screen->id ) {
            ...
            $text = sprintf( __( 'If you like <strong>%1$s</strong> please leave us a %2$s rating. A huge thank you from <strong>CodeVibrant</strong> in advance!', 'news-vibrant' ), esc_html( $theme_name ), '<a href="https://wordpress.org/support/theme/news-vibrant/reviews/?filter=5" class="theme-rating" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a>' );
